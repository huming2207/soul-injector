...
esp_err_t offline_asset_manager::init()
{
...
esp_err_t offline_asset_manager::get_algo_bin(uint8_t *algo, size_t len, size_t *actual_len)
{
...
esp_err_t offline_asset_manager::get_pc_init(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_INIT, out);
}

esp_err_t offline_asset_manager::get_pc_uninit(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_UNINIT, out);
}

esp_err_t offline_asset_manager::get_pc_program_page(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_PROGRAM_PAGE, out);
}

esp_err_t offline_asset_manager::get_pc_erase_sector(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_ERASE_SECTOR, out);
}

esp_err_t offline_asset_manager::get_pc_erase_all(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_ERASE_CHIP, out);
}

esp_err_t offline_asset_manager::get_pc_verify(uint32_t *out)
{
    return algo_parser.get_func_pc(FUNC_NAME_VERIFY, out);
}

esp_err_t offline_asset_manager::get_data_section_offset(uint32_t *out)
{
...
esp_err_t offline_asset_manager::get_fw_crc(uint32_t *out)
{
    return ESP_OK;
}

esp_err_t offline_asset_manager::get_algo_crc(uint32_t *out)
{
    return ESP_OK;
}
