...
esp_err_t ui_screen_message_279::init(lv_obj_t *_base_obj)
{
    ...
    comment_label = lv_label_create(base_obj);
...
void ui_screen_message_279::deinit()
{
    if (base_obj != nullptr) {
        lv_obj_del(base_obj);
    }
...
void ui_screen_message_279::set_header_text(const char *text)
{
...
void ui_screen_message_279::set_comment_text(const char *text)
{
...
void ui_screen_message_279::set_color(lv_color_t background, lv_color_t text)
{
