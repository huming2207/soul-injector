...
public:
    ...
    esp_err_t get_algo_bin_len(size_t *out);
    esp_err_t get_ram_size_byte(uint32_t *out);
    ...
    esp_err_t get_flash_start_addr(uint32_t *out);
    esp_err_t get_flash_end_addr(uint32_t *out);
    esp_err_t get_page_size(uint32_t *out);
    esp_err_t get_erased_byte_val(uint32_t *out);
    esp_err_t get_program_page_timeout(uint32_t *out);
    esp_err_t get_erase_sector_timeout(uint32_t *out);
    esp_err_t get_sector_size(uint32_t *out);
